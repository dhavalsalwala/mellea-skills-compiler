...
**Rule OUT-2 — Package name.** The wrapper computes `<package_name>` and injects it into the system prompt. Use the injected value verbatim. The derivation logic lives in `compile/mellea_skills.py::_derive_mellea_package_name`.
