...
def _guardian_inline_snippet(enforce: bool = False) -> str:
    ...
    return (
        ...
        "from mellea_skills_compiler.plugins.guardian import GuardianPluginFactory\n"
        ...
        "manifest_path = adapter_dir / 'policy_manifest.json'\n"
        "guardian_plugin = None\n"
        "audit_plugin = None\n"
        "if manifest_path.exists():\n"
        "    manifest = PolicyManifest.from_json(manifest_path)\n"
        ...
        "        sys.exit(1)\n"
        "    audit_plugin = AuditTrailPlugin(log_path=_audit_dir / 'runtime_audit.jsonl', guardian_plugin=guardian_plugin)\n"
